...
const AboutUs: FC = () => {
  ...
  const values: Value[] = [
    {
      title: "Innovation",
      description: "We push the boundaries of bioinformatics with advanced algorithms and state-of-the-art technology to unlock genomic insights."
    },
    {
      title: "Integrity",
      description: "We uphold the highest standards of data privacy, security, and ethical practices in all our operations."
    },
    {
      title: "Collaboration",
      description: "We partner with researchers, clinicians, and institutions to accelerate discoveries and improve human health."
    }
  ];
      ...
      <header className="bg-blue-700 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-lg text-center mt-4 max-w-3xl mx-auto">
            Pioneering the future of bioinformatics through innovation, collaboration, and cutting-edge technology.
          </p>
        </div>
      </header>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto text-center">
            Our vision is to accelerate scientific breakthroughs by providing a seamless, innovative bioinformatics ecosystem that bridges data and discovery.
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            <div>
              <p className="text-lg text-center md:text-left max-w-3xl mx-auto mb-8">
                Want to learn more about Kaidoku? Reach out to us to explore how we can support your bioinformatics needs.
              </p>
              <div className="space-y-6">
                <div className="flex items-start">
                  <svg className="w-6 h-6 mr-4 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path>
                  </svg>
                  <div>
                    <h3 className="text-lg font-semibold">Email Us</h3>
                    <p className="text-gray-200">General Inquiries: info@kaidoku.com</p>
                    <p className="text-gray-200">Support: support@kaidoku.com</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <svg className="w-6 h-6 mr-4 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
